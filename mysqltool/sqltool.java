...
public class sqltool {
	...
	public static String getitem(int id) throws Exception {
        ...
        String result ="";
        if(rs.next()){
            result += rs.getString("commodityId")+"&"+rs.getString("commodityName")+"&"+rs.getString("price")+"&"+rs.getString("agio")+"&"+rs.getString("picture")+"&"+rs.getString("commodityTypeName")+"&"+rs.getString("typepicture");
            }
		return result;
	}
