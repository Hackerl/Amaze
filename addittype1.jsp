...
<html>
	...
	<body>
	    ...
	    if( type == null || type.equals("")) {   //信息不能为空，前端同时用js检测
		    //out.println("信息不能为空!!");
		    response.sendRedirect("addittype.jsp");             //重定向到注册
		    return;
            }
        ...
        int success = -1;
        try {
            success = sqltool.addittype(type,picture);
